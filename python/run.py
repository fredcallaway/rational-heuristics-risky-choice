...
def statistics():
    ...
    rs.strategy_postHoc_cohenD(human_file, stats_dir)

    rs.behavioral_features(human_file, stats_dir, print_summary=True)

    model_file = '../data/model/exp1/processed/trials.csv'
    human_file = '../data/human/1.0/processed/trials.csv'
    model_file_fitcost = '../data/model/exp1_fitcost/processed/trials.csv'
    stats_dir = '../stats/exp1/'
    ...
    rs.exp2_strategy(human_file1, human_file2, stats_dir, print_summary=True)
    rs.exp2_behavior(human_file1, human_file2, stats_dir, print_summary=True)
    rs.under_performance(human_file1, stats_dir)
    rs.under_performance(human_file2, stats_dir)
